...
import champions from "./champsleage.png";
import eredevisie from "./eredivisie.png";
import laliga from "./laliga.png";
import ligue1 from "./ligue1.png";
...
export const images = [
  {
    src: laliga,
    describe: "Spanish Laliga",
  },
  {
    src: bundesliga,
    describe: "German bundesliga",
  },
  {
    src: serieA,
    describe: "Serie A",
  ...
  {
    src: champions,
    describe: "UEFA champions league",
  },
];
